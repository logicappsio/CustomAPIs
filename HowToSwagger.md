...
To learn how to add Swagger to your WebAPI in general, see [Swashbuckle](https://github.com/domaindrivendev/Swashbuckle/blob/master/README.md).

### Schema extensions
In addition to the standard Swagger specifications, there are some additional swagger extensions available when creating an API for PowerApps. This section lists and describes these extensions. 
